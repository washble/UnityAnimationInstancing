...
public class URPAnimationInstancing : MonoBehaviour
{
    ...
    public URPAnimationInstancing parentInstance { get; set; }
    ...
    [NonSerialized]
    private List<URPAnimationInstancing> listAttachment;
    ...
    void Start()
    {
        ...
        listAttachment = new List<URPAnimationInstancing>();
    ...
    public void UpdateAnimation()
    {
        ...
        for (int i = 0; i != listAttachment.Count; ++i)
        {
            URPAnimationInstancing attachment = listAttachment[i];
    ...
    public void Attach(string boneName, URPAnimationInstancing attachment)
    {
        int index = -1;
    ...
    public void Deattach(URPAnimationInstancing attachment)
    {
    ...
    private void RefreshAttachmentAnimation(int index)
    {
        ...
        {
            URPAnimationInstancing attachment = listAttachment[k];
