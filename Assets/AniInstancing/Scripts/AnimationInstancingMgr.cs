...
public class AnimationInstancingMgr : Singleton<AnimationInstancingMgr>
{
    ...
    List<URPAnimationInstancing> aniInstancingList;
...
//                 vertexCache.currentInstancingIndex = 0;
    ...
    public GameObject CreateInstance(GameObject prefab)
    {
        ...
        URPAnimationInstancing script = obj.GetComponent<URPAnimationInstancing>();
        URPAnimationInstancing prototypeScript = prefab.GetComponent<URPAnimationInstancing>();
    ...
    public void RemoveInstance(URPAnimationInstancing instance)
    {
    ...
    void ApplyBoneMatrix()
    {
        ...
        {
            URPAnimationInstancing instance = aniInstancingList[i];
            ...
            URPAnimationInstancing.LodInfo lod = instance.lodInfo[instance.lodLevel];
    ...
    private void ApplyRootMotion(URPAnimationInstancing instance)
    {
    ...
    public void AddMeshVertex(string prefabName,
        URPAnimationInstancing.LodInfo[] lodInfo,
        Transform[] bones,
        ...
        string alias = null)
    {
        ...
        {
            URPAnimationInstancing.LodInfo lod = lodInfo[x];
    ...
    public void AddBoundingSphere(URPAnimationInstancing instance)
    {
