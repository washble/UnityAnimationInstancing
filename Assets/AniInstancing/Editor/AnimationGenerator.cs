    ...
    public class AnimationGenerator : EditorWindow
    {
                        ...
                        if (EditorGUI.EndChangeCheck())
                        {
                            if (fbx != generatedFbx)
                            {
                                ...
                                for (int i = 0; i != allTrans.Count; ++i)
                                {
                                    ...
                                    Debug.Log($"Select Bone : {allTrans[i].name}");
                                }
                            }
                            else if (fbx == null)
                            {
        ...
        void BakeWithAnimator()
        {
            if (generatedPrefab != null)
            {
                ...
                URPAnimationInstancing script = generatedObject.GetComponent<URPAnimationInstancing>();
                Debug.Assert(script);
        ...
        void AnalyzeStateMachine(UnityEditor.Animations.AnimatorStateMachine stateMachine,
            ...
            int animationIndex)
        {
            URPAnimationInstancing instance = generatedPrefab.GetComponent<URPAnimationInstancing>();
            if (instance == null)
            {
        ...
        static void DrawGizmo(URPAnimationInstancing instance, GizmoType gizmoType)
        {
